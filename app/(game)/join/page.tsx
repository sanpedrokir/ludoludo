...
export default function JoinPage() {
  ...
  const [step, setStep] = useState<'code' | 'color'>(defaultCode ? 'code' : 'code')
    ...
    return (
      <div className="px-6 py-8 flex flex-col gap-6 max-w-md mx-auto w-full">
        <div>
          ...
          <p className="text-amber-600 text-sm">Code: <span className="font-black font-mono text-amber-900">{code}</span></p>
        </div>
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${isAvailable ? 'cursor-pointer hover:scale-105' : 'opacity-30 cursor-not-allowed'}
                  bg-white shadow-sm
                `}
              >
  ...
  return (
    <div className="px-6 py-8 flex flex-col gap-6 max-w-md mx-auto w-full">
      <div>
        ...
        <p className="text-amber-700 text-sm">Enter the 6-character code to join.</p>
      </div>
